...
uint32_t pulseIn( uint32_t pin, uint32_t state, uint32_t timeout )
{
   ...
   uint32_t numloops = 0;
   uint32_t maxloops =  timeout * ( get_CPUClock() / 16000000);
   ...
   return (uint32_t)( ( (unsigned long long)(width+5) *  (unsigned long long) 16000000.0) /(unsigned long long)get_CPUClock() ) ;
}
