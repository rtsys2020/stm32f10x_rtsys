...
#define SPIFFS_PHYS_ADDR ((uint32_t) ( 0x00000))
#define SPIFFS_PHYS_SIZE ((uint32_t) (0x800000))
#define SPIFFS_PHYS_PAGE ((uint32_t)256)
#define SPIFFS_PHYS_BLOCK ((uint32_t)0x10000)


#define SPIFFS_MAX_OPEN_FILES ((uint32_t)5)
